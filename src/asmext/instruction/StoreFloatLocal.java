...
public class StoreFloatLocal implements StoreLocal {
	...
	public StoreFloatLocal(int opcode, List<TryCatchBlockNode> surroundingTCBs) {
	...
	public StoreFloatLocal(int opcode, int varIndex, List<TryCatchBlockNode> surroundingTCBs) {
